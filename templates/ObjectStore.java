...
import ${Package}.handler.CoreDataMessageHandler;
...
public class ObjectStore {
	...
	public void put(Device device, ResourceOperation operation, String value) {
		...
		List<${Protocol name}Object> objectsList = createObjectsList(operation, device);
		
		String deviceId = device.getId();
		List<Reading> readings = new ArrayList<>();
		
		for (${Protocol name}Object obj: objectsList) {
	...
	private List<${Protocol name}Object> createObjectsList(ResourceOperation operation, Device device) {
		Map<String, ${Protocol name}Object> objects = profiles.getObjects().get(device.getName());
		List<${Protocol name}Object> objectsList = new ArrayList<${Protocol name}Object>();
		if (operation != null && objects != null) {
			${Protocol name}Object object = objects.get(operation.getObject());
	...
	private String transformResult(String result, ${Protocol name}Object object, Device device, ResourceOperation operation) {
