...
public class ${Protocol name}Handler {
	...
	private final static EdgeXLogger logger = EdgeXLoggerFactory.getEdgeXLogger(${Protocol name}Handler.class);
	...
	private void executeOperations(Device device, String commandName, String arguments, Boolean immediate, String transactionId) {
		...
		for (ResourceOperation operation: operations) {
			...
			${Protocol name}Object object = get${Protocol name}Object(objects, objectName, transactionId);
	...
	private ${Protocol name}Object get${Protocol name}Object(Map<String, ${Protocol name}Object> objects, String objectName, String transactionId) {
	...
	private String parseArguments(String arguments, ResourceOperation operation, Device device, ${Protocol name}Object object, Map<String, ${Protocol name}Object> objects) {
