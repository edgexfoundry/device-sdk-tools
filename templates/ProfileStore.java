...
public class ProfileStore {
	...
	// profile
	// object key
	private Map<String, Map<String, ${Protocol name}Object>> objects = new HashMap<>();
	
	public Map<String, Map<String, ${Protocol name}Object>> getObjects() {
		return objects;
	}
	...
	public void addDevice(Device device) {
		...
		for (DeviceObject object: device.getProfile().getDeviceResources()) {
			${Protocol name}Object ${Protocol name}Object = new ${Protocol name}Object(object);
			
			PropertyValue value = object.getProperties().getValue();
			
			deviceObjects.put(object.getName(), ${Protocol name}Object);
